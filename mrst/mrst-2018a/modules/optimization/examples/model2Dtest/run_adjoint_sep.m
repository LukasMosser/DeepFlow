...
model_ref  = load('utils/vertcase/model_ref.mat');%                   
...
% load ref model
ws_ref = load('utils/vertcase/ws_ref.mat');
ws_ref = ws_ref.ws_ref;

states_ref = load('utils/vertcase/states_ref.mat');
states_ref = states_ref.states_ref;

r_ref = load('utils/vertcase/r_ref.mat');
r_ref = r_ref.r_ref;
...
save('utils/synthetic/grad_ow.mat', 'sens');
save('utils/synthetic/misfit_ow.mat', 'misfitVal');
save('utils/synthetic/ws.mat', 'ws');

%% setup misfit-function and run adjoint to get parameter sensitivities
% setup weights for matching function, empty weight uses default (will 
% produce function value of ~O(1) for 100% misfit). Only match rates in this example: 
weighting =  {'WaterRateWeight',     0, ...
              'OilRateWeight',       0, ...
              'BHPWeight',           []};
...
save('utils/synthetic/grad_p.mat', 'sens');
save('utils/synthetic/misfit_p.mat', 'misfitVal');